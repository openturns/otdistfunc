...
import otdistfunc.remote_communicator
import os
import tempfile
...
check_rc(otdistfunc.remote_communicator.RemoteCommunicatorSSH())

try:
    import paramiko
    check_rc(otdistfunc.remote_communicator.RemoteCommunicatorParamiko())
except:
