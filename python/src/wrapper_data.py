...
class WrapperDataCoreIn(WrapperData):
    ...
    def __init__(self):
        super(WrapperDataCoreIn, self).__init__()
        self.point = None
        self.user_data = None
    ...
    def write(self):
        ...
        pickle.dump(self.user_data, self.handle)
        self.close_file()
    ...
    def read(self):
        ...
        self.user_data = pickle.load(self.handle)
        self.close_file()
...
class WrapperDataCoreOut(WrapperDataCoreIn):
    ...
    def __init__(self):
        super(WrapperDataCoreOut, self).__init__()
        self.err_msg = ''
    ...
    def read(self):
        try:
            ...
            self.err_msg = 'Could not read core file.'
            raise
...
class WrapperDataHostIn(WrapperData):
    ...
    def __init__(self, hostname=None):
        super(WrapperDataHostIn, self).__init__()
    ...
    def copy(self, wd_host_in):
        ...
        self.user_data = wd_host_in.user_data
...
class WrapperDataHostOut(WrapperData):
    ...
    def __init__(self, remote=False):
        super(WrapperDataHostOut, self).__init__()
        # the out sample
        self.sample = None
    ...
    def add_log(self, flag, data, timestamp=None):
        """ thread safe """
        self.mutex.acquire()
    ...
    def add_point(self, point_id, point_data, compute_time):
        self.add_log(self.flag_point, [point_id, point_data, compute_time])
    ...
    def write_sample(self):
        ...
        self.mutex.acquire()
        self.write(
            [self.flag_sample, time.time(), [self.sample, self.flag_end]])
        self.mutex.release()
    ...
    def get_data(self):
        ...
        if self.sample:
            ...
            for log in self.logs:
                if log[0] == self.flag_point:
                    point_log = log[2]
                    point_id = point_log[0]
                    point_data = point_log[1]
                    partial_sample.append([point_id, point_data])

            if len(partial_sample) == 0:
                return None
            else:
                print('A partial sample has been found '
                      '(struct: [[point_id, point_content], ...] )!')
...
class WrapperDataHostsIn(WrapperDataHostIn):
    ...
    def __init__(self, hostname=None):
        ...
        super(WrapperDataHostsIn, self).__init__(hostname)
        self.scheduler = None
        # contain [[hostname, weight], [hostname, weight], ...]
        self.hosts = []
...
class WrapperDataHostsOut(WrapperDataHostOut):
    ...
    def __init__(self, remote=False):
        ...
        super(WrapperDataHostsOut, self).__init__(remote=False)
